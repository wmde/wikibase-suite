...
- Lifecycle commands reuse the checkout's selected tools image when it exists locally and pull it only when it is missing. They do not check the registry for a newer image.
