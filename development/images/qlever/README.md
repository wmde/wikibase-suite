...
[`wdqs-qlever-updater`](../wdqs-qlever-updater/README.md) image to synchronize Wikibase
changes.
...
| `QLEVER_SERVICE_ALLOWED_IRI_PREFIXES` | `https://query.wikidata.org/` | Whitespace-separated allowlist of IRI prefixes for federated `SERVICE` requests. |
